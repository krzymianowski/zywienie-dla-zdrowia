...
final class ZFDZ_WordPress_Lab_Result_Storage {
	...
	/**
	 * Returns the public URL of the managed laboratory result directory without creating it.
	 *
	 * @return string|WP_Error
	 */
	public function get_lab_result_directory_url(): string|WP_Error {
		...
		return trailingslashit( $managed_root_url ) . self::LAB_RESULT_DIRECTORY_NAME;
	}
