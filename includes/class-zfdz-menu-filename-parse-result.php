<?php
/**
 * Menu filename parse result.
 *
 * @package ZywienieDlaZdrowia
 */

/**
 * Represents either a parsed menu document or a machine-readable error code.
 */
final class ZFDZ_Menu_Filename_Parse_Result {
	 ...
	 *
	 * @var ZFDZ_Menu_Document|null
	 */
	private readonly ?ZFDZ_Menu_Document $document;
	 ...
	 * @param ZFDZ_Menu_Document|null $document   Parsed document.
	 * @param string|null             $error_code Machine-readable error code.
	 */
	private function __construct( bool $valid, ?ZFDZ_Menu_Document $document, ?string $error_code ) {
		$this->valid      = $valid;
	 ...
	 *
	 * @param ZFDZ_Menu_Document $document Parsed document.
	 * @return self
	 */
	public static function from_document( ZFDZ_Menu_Document $document ): self {
	 ...
	 *
	 * @return ZFDZ_Menu_Document|null
	 */
	public function get_document(): ?ZFDZ_Menu_Document {
